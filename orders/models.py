...
class OrderItem(models.Model):
    ...
    coupon = models.ForeignKey(
        Coupon, related_name="order_item", on_delete=models.CASCADE, null=True)
    order = models.ForeignKey(
        Orders, related_name="order_items", on_delete=models.CASCADE, null=False)
    product = models.ForeignKey(
        Product, related_name="orders", on_delete=models.CASCADE, null=False)
    variant = models.ForeignKey(
        Variant, related_name="order_items", on_delete=models.CASCADE, null=False)
