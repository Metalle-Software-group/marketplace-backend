...
class Coupon(models.Model):
    discount = models.DecimalField(
        max_length=10, null=False, decimal_places=0, max_digits=3)
    ...
    vendor = models.ForeignKey(
        Vendor, related_name="coupon_vendor", on_delete=models.CASCADE)
    product = models.ForeignKey(
        Product, related_name="coupon", on_delete=models.CASCADE)
